...
/// version:
/// 1.0`
+ (void)payWithTheAmount:(GDAmount * _Nonnull)amount withCardDetails:(GDCardDetails * _Nonnull)cardDetails initializeResponse:(GDInitiateAuthenticateResponse * _Nullable)initializeResponse config:(GDConfigResponse * _Nullable)config isHPP:(BOOL)isHPP showReceipt:(BOOL)showReceipt andTokenizationDetails:(GDTokenizationDetails * _Nullable)tokenizationDetails andPaymentIntentId:(NSString * _Nullable)paymentIntentId andCustomerDetails:(GDCustomerDetails * _Nullable)customerDetails orderId:(NSString * _Nullable)orderId paymentMethods:(NSArray<NSString *> * _Nullable)paymentMethods sessionId:(NSString * _Nullable)sessionId dismissAction:(void (^ _Nullable)(GDCancelResponse * _Nullable, GDErrorResponse * _Nullable))dismissAction navController:(UIViewController * _Nonnull)navController completion:(void (^ _Nonnull)(GDOrderResponse * _Nullable, GDErrorResponse * _Nullable))completion;
+ (void)initiateAuthenticateWithTheAmount:(GDAmount * _Nonnull)amount withCardNumber:(NSString * _Nullable)cardNumber andTokenizationDetails:(GDTokenizationDetails * _Nullable)tokenizationDetails andPaymentIntentId:(NSString * _Nullable)paymentIntentId andCustomerDetails:(GDCustomerDetails * _Nullable)customerDetails orderId:(NSString * _Nullable)orderId paymentMethods:(NSArray<NSString *> * _Nullable)paymentMethods dismissAction:(void (^ _Nullable)(GDCancelResponse * _Nullable, GDErrorResponse * _Nullable))dismissAction navController:(UIViewController * _Nonnull)navController completion:(void (^ _Nonnull)(GDInitiateAuthenticateResponse * _Nullable, GDErrorResponse * _Nullable, NSString * _Nullable))completion;
